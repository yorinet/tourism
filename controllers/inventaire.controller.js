const InventaireModel = require('../models/inventaire.model');

exports.getAll = async function(request, response) {
    await InventaireModel.getAll(function(error, result) {
...
exports.getById = async function(request, response) {
    await InventaireModel.getById(request.params.id, function(error, result) {
...
exports.create = async function(request, response) {
  ...
  if(body.constructor === Object && Object.keys(body).length === 0){
    ...
    await InventaireModel.create(body, function(error, result) {
        if (error) { response.send(error) }
...
exports.delete = async function(request, response) {
    ...
    await InventaireModel.delete(id, function(error, result) {
      if (error) { response.send(err) }
...
exports.update = async function(request, response) {
  ...
  if(body.constructor === Object && Object.keys(body).length === 0){
    ...
    await InventaireModel.update(body, function(err, result) {
